package org.example.reportingservice.exception;
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(org.example.reportingservice.system.exception.BackupConflictException.class)
    public ResponseEntity<ApiResponse<Void>> handleBackupConflictException(org.example.reportingservice.system.exception.BackupConflictException ex) {
        log.warn("Backup conflict error: {}", ex.getMessage());
        return ResponseEntity.status(HttpStatus.CONFLICT)
                .body(ApiResponse.error(HttpStatus.CONFLICT.value(), ex.getMessage()));
    }

    @ExceptionHandler(org.example.reportingservice.system.exception.InsufficientDiskSpaceException.class)
    public ResponseEntity<ApiResponse<Void>> handleInsufficientDiskSpaceException(org.example.reportingservice.system.exception.InsufficientDiskSpaceException ex) {
