...
import org.example.internservice.intern.service.impl.InternDocumentServiceImpl;
...
class InternDocumentServiceTest {
    ...
    void setUp() {
        mockInternProfile = InternProfile.builder()
                ...
                .status(org.example.internservice.intern.entity.enums.InternStatus.PENDING)
                .build();
    }
    ...
    void uploadDocument_whenInternProfileIsClosed_shouldThrowBadRequestException() {
        ...
        mockInternProfile.setStatus(org.example.internservice.intern.entity.enums.InternStatus.COMPLETED);
        when(internProfileRepository.findByInternCode("INT-202609-0001"))
                .thenReturn(Optional.of(mockInternProfile));
